...
public class TC_MRI_002_TransferToAnotherSuite extends CRAFTTestCase
{
	@Test(dataProvider = "RegressionTestScripts")
	public void runTC_NewApplication_MRI_001(String testInstance, ExecutionMode executionMode, Platform platform
